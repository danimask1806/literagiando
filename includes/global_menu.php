														...
														<ul class="sub-menu">
															...
															<li class="menu-item-has-children pt-1">
																<a class="aa2 dropdown-itemm" href="administrar_usuarios.php" style="font-size: 18px;">
																	<span class="mm-text">
																		&nbsp;&nbsp;&nbsp;<i class="fa fa-users" aria-hidden="true" style="color: white;"></i>&nbsp;&nbsp;Administrar usuario
																	</span>
																</a>
															</li>
															<li class="menu-item-has-children pt-1">
														...
														<ul class="sub-menu">
															...
															<li>
																<a class="aa2 dropdown-itemm" href="historico_usuarios.php'.$codificacion.'" target="Blank">
																	<span class="mm-text">
																		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-angle-double-right" aria-hidden="true" style="color: #ffcb00;"></i>&nbsp;&nbsp;Histórico de usuario
																	</span>
																</a>
															</li>
															<li>
