...
<html lang="es">
	...
	<head>
		...
		<!-- .Titulo -->
		<title>Administrar usuario - <?php echo base_titulo_2; ?></title>
...
<?php const base_tabla_titulo = 'Administrar usuario'; ?>
...
<?php
	...
	$query = "SELECT usuario.id_usuario,usuario.identificacion,usuario.nombre_completo,usuario.sexo,usuario.telefono,usuario.correo,usuario.usuario,usuario.foto_perfil,usuario.acceso,usuario.fecha_registro, roles.rol
	FROM usuario
	LEFT JOIN roles ON usuario.rol = roles.id_rol
