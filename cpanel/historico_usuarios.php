...
$query = "SELECT usuario.id_usuario,usuario.identificacion,usuario.nombre_completo,usuario.sexo,usuario.telefono,usuario.correo,usuario.usuario, accesos.acceso, roles.rol
FROM usuario
LEFT JOIN accesos ON usuario.acceso = accesos.id_acceso
LEFT JOIN roles ON usuario.rol = roles.id_rol WHERE usuario.id_usuario NOT IN (1)";
